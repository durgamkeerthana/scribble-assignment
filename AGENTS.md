...
`specs/005-scoring-hosting/plan.md`
See also `specs/005-scoring-hosting/data-model.md` for entity definitions and
`specs/005-scoring-hosting/contracts/api.md` for API contracts.
<!-- SPECKIT END -->
