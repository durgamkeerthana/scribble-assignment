...
`specs/002-game-start-flow/plan.md`
See also `specs/002-game-start-flow/data-model.md` for entity definitions and
`specs/002-game-start-flow/contracts/api.md` for API contracts.
<!-- SPECKIT END -->
